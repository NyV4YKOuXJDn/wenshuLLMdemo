...
import { Activity, BookOpen, FileText, PieChart, Heart, Clipboard, 
         Sparkles, Pill, AlertCircle, LineChart, ArrowLeft,
         CheckCircle2, ClipboardCheck, Syringe, AlertTriangle, BadgeAlert } from 'lucide-react';
...
export default function SceneExamples() {
  ...
  const scenes: Scene[] = [
    ...
    },
    {
      icon: <Syringe />,
      title: "用药记录摘要",
      description: "AI分析用药规律与变化",
      gradient: "from-pink-500 to-rose-500",
      content: "用药记录明细：\n\n1. 长期医嘱\n- 硝苯地平缓释片 30mg Qd\n- 阿司匹林肠溶片 100mg Qd\n\n2. 临时医嘱\n- 2024-01-19 头痛给予布洛芬\n- 2024-01-20 血压升高加用卡托普利\n\n3. 用药反应\n- 偶有头晕\n- 无其他不适",
      aiOutput: "用药分析报告：\n\n1. 用药规律：\n- 基础降压用药稳定\n- 抗血小板治疗规范\n\n2. 近期变化：\n- 新增临时降压药物\n- 有症状性用药需求\n\n3. 注意事项：\n- 监测血压变化趋势\n- 关注头晕症状\n- 避免降压药物重复"
    },
    {
      icon: <AlertTriangle />,
      title: "冲突医嘱检测",
      description: "自动识别医嘱冲突风险",
